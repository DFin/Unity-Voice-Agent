...
- NativeWebSocket transport + OpenAI / ElevenLabs realtime controllers (connect, configure sessions, relay mic audio, log server events, and spawn a fallback AudioListener when needed).
